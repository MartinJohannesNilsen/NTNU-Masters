...
class LSTMTextClassifier(nn.Module):
    ...
    def forward(self, x, length):
        ...
        embs = x #pad_embeddings(self.embedding(x), ) if self.embedding else x
...
def grid_search_lstm(emb_type: str, max_len: int, batch_size=batch_size, stair_twitter=stair_twitter, pad_pos=pad_pos)
...
if __name__ == "__main__":
    main(emb_type="bert", max_len=512, pad_pos="tail", batch_size=200, stair_twitter=True, num_epochs=10)