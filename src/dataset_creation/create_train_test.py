...
if __name__ == "__main__":
    ...
    final_train.to_csv(target_path / "train_sliced_stair_twitter.csv", sep="‎", quoting=QUOTE_NONE, index=False)
    final_test.to_csv(target_path / "test_sliced_stair_twitter.csv", sep="‎", quoting=QUOTE_NONE, index=False)
